...
export function HousingCostForm() {
  ...
  const calcPreview = () => {
    ...
    const previewCity = Math.round((landCityBase + buildingAssessed) * 0.003 * 10) / 10
      ...
      {showCalc && (
        <div className="border border-blue-200 bg-blue-50 rounded-lg p-4 space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-500">固定資産税1.4%・都市計画税0.3%。土地は住宅用地特例（小規模:1/6、一般:1/3）を適用します。</p>
          </div>
